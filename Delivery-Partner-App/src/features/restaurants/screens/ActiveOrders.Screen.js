...
export const ActiveOrdersScreen = () => {
    ...
    useEffect(() => {
        ...
        const fetchOrdersData = async () => {
            ...
            try {
             ...
             const response = await axios.post(SERVERACCESS + "/order/ActiveOrders", json, {
                   headers: {
  ...
  const handleAcceptOrder = (orderId) => {
    ...
    const acceptorder = async () => {
     ...
     const response = await axios.post(SERVERACCESS + "/order/CompleteOrder", json, {
           headers: {
         // Overwrite Axios's automatically set Content-Type
         'Content-Type': 'application/json'
       }});
     const refresh = await axios.post(SERVERACCESS + "/order/ActiveOrders"); // Replace '/api/orders' with your MongoDB API endpoint
  ...
  const handleRejectOrder = (orderId) => {
    ...
    const acceptorder = async () => {
     ...
     const response = await axios.post(SERVERACCESS + "/order/RejectOrder", json, {
           headers: {
         // Overwrite Axios's automatically set Content-Type
         'Content-Type': 'application/json'
       }});
